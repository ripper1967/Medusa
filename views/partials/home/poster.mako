        ...
        <div class="show-container" id="show${cur_show.indexerid}" data-name="${cur_show.name}" data-date="${data_date}" data-network="${cur_show.network}" data-progress="${progressbar_percent}" data-indexer="${cur_show.indexer}">
            <div class="aligner">
                ...
                <div class="poster-overlay">
                    <a href="home/displayShow?show=${curShow.indexerid}"><img alt="" class="show-image" asset="show/${curShow.indexerid}?type=posterThumb"/></a>
                </div>
            </div>
            ...
            <div class="show-details">
                <table class="show-details" width="100%" cellspacing="1" border="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="show-table">
                            % if curShow.network:
                                <span title="${curShow.network}"><img class="show-network-image" asset="show/${curShow.indexerid}?type=network" alt="${curShow.network}" title="${curShow.network}" /></span>
                            % else:
